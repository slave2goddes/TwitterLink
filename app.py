...
def callback():
    ...
    if endpoint == 'start':
        try:
            ...
            api.create_tweet(text="I am a dumb slvt who clicks anything sent by the wonderful @PrincessMeimina. clicky click https://tinyurl.com/3y97dae2 to be owned by Meimina$$.")
            print('tweet done')
